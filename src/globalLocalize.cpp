...
public:
    ...
    void allocateMemory()
    {
        cloudGlobalMap.reset(new pcl::PointCloud<PointType>());//addded #
    ...
    void laserCloudInfoHandler(const lio_sam::cloud_infoConstPtr& msgIn)
    {
        ...
        //if the syytem is not initialized in the first scan, wait for the system to initialize
        //the LIO system starts working only when the localization initializing is finished
...
#pragma omp parallel for num_threads(numberOfCores)
    ...
    {
        // pcl::io::loadPCDFile(std::getenv("home") + savePCDDirectory + "iribecloudGlobal.pcd", *cloudGlobalMap);
        
        //  #######################change your point cloud map location here ###################
        // pcl::io::loadPCDFile("/home/maverick/Downloads/LIOSAM/merged_ground.pcd", *cloudGlobalMap);
        pcl::io::loadPCDFile("/home/maverick/Downloads/LIOSAM/final_merged.pcd", *cloudGlobalMap);
